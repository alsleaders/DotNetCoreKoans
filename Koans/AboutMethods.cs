...
namespace DotNetCoreKoans.Koans
{
  ...
  public class AboutMethods : Koan
  {
    ...
    // {
    //   Assert.Equal(String["Cory", "Will", "Corey"], this.LocalMethodWithVariableParameters("Cory", "Will", "Corey"));
    // }
    ...
    // {
    //   Assert.Equal(String [] ["Cory", "Will", "Corey"], LocalMethodWithVariableParameters("Cory", "Will", "Corey"));
    // }
